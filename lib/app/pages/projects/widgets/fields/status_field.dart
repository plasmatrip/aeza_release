        ...
        GestureDetector(
          ...
          onTap: () async {
            ...
            if (status != null && context.mounted) {
              context.read<ProjectRepo>().status = status;
            }
          },
          child: Container(
            key: globalKey,
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    context.watch<ProjectRepo>().status != null
                        ? Text(ProjectStatus.values[context.read<ProjectRepo>().status!].name, style: context.s14w400.copyWith(color: black))
                        : Text('Текущий статус проекта', style: context.s14w400.copyWith(color: grey_3)),
                    SvgPicture.asset(
