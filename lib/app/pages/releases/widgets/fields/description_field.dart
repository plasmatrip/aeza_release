...
class _DescriptionFieldState extends State<DescriptionField> {
  ...
  @override
  void initState() {
    controller = TextEditingController(text: context.read<ReleasesRepo>().description);
    super.initState();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                onChanged: (value) => context.read<ReleasesRepo>().description = value,
                style: context.s14w400.copyWith(color: black),
                minLines: 3,
                maxLines: 12,
                decoration: InputDecoration.collapsed(
                  border: InputBorder.none,
                  hintText: 'Описание релиза',
